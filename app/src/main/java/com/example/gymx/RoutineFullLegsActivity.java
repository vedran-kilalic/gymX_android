...
public class RoutineFullLegsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_routine_full_legs);

        generateRoutine = findViewById(R.id.gen_routine_full_legs_button);
        routine = findViewById(R.id.routine_full_legs);
